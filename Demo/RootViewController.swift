...
class RootViewController: LiftNavigationController {
    ...
    public init() {
        let style = NavigationBarStyle(bottomImage: UIImage(named: "switch-button-up")!, topImage: UIImage(named: "switch-button-down")!, font: UIFont.systemFont(ofSize: 24), activeTextColor: .liftBlue(), inactiveTextColor: .lightGray, spacing: 20)
